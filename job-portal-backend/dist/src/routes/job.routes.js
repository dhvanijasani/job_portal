...
const company_middleware_1 = require("../middlewares/company.middleware");
const router = express_1.default.Router();
router.get("/", job_controller_1.getJobs);
router.get("/:id", job_controller_1.getJobById);
router.post("/", auth_middleware_1.protect, company_middleware_1.companyOnly, job_controller_1.createJob);
